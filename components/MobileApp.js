...
function MobileApp() {
  return (
    <div className="container mx-auto flex justify-between items-center bg-primary-brand-color bg-mobile-app mt-7 rounded-lg text-white">
      <div className="flex flex-col gap-y-3 p-10">
        <h3 className="text-2xl font-bold tracking-tighter">Getir'i indirin</h3>
        <p className="font-semibold ">
          İstediğiniz ürünleri dakikalra içinde kapınıza
          <br /> getirelim.
        </p>
